...
export function CompetitionSettings({
  ...
  return (
    <section className="rounded-xl border border-white/10 bg-slate-900 p-3 sm:p-5" aria-labelledby="reglages-titre">
...
export function CompetitionSteps({ concours }: { concours: ConcoursPourDeroule }) {
  ...
  return (
    <section className="rounded-xl border border-white/10 bg-slate-900 p-3 sm:p-5" aria-labelledby="deroule-titre">
