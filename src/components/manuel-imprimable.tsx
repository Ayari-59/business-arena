...
/**
 * LE MANUEL, RENDU UNE SEULE FOIS POUR DEUX ADRESSES.
 *
 * Il vit à /manuel, en lecture pour qui veut le lire — un enseignant qui hésite
 * à créer un compte, un corps d'inspection à qui l'on a présenté l'outil — et à
...
export async function ManuelImprimable({
  ...
  /** Le lien « retour » de l'en-tête, qui change selon d'où l'on vient. */
