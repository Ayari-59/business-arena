...
export default async function ArenaPage({
      ...
      <div className="space-y-3">
        {situations.current.map((s, i) => (
          ...
          >
            ...
            <div className="border-t border-white/10 px-0.5 py-2.5 sm:p-4">
  ...
  return (
    <main id="main" className="mx-auto max-w-5xl px-1 pt-5 pb-12 sm:px-6">
      {/* ── Header ── */}
      ...
      <div className="mt-4 space-y-2">
        ...
        {hasActivePeriod ? (
          ...
          >
            ...
            <div className="px-0.5 py-2.5 sm:p-4">
