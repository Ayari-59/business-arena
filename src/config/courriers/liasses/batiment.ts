...
export const BATIMENT_COURRIERS: CourrierDef[] = [
  ...
  },
  {
    ...
    corps:
      "Les délais de règlement constatés sur vos marchés publics allongent votre besoin de financement. Nous révisons en conséquence les conditions de votre découvert et de votre ligne de mobilisation de créances.",
