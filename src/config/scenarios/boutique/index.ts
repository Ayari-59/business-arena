...
const rawBoutique = {
  ...
  events: [
    ...
    },
    {
      ...
      duration: 1,
      modifiers: [
        { target: "demand:pull_passage", op: "mul", value: 0.8 },
        { target: "demand:cardigan_passage", op: "mul", value: 0.8 },
        { target: "demand:echarpe_passage", op: "mul", value: 0.8 },
        { target: "demand:bonnet_passage", op: "mul", value: 0.8 },
      ],
    },
    {
