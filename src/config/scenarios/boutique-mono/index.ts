 ...
 * prêt-à-porter indépendant, 6 tours trimestriels, UN article de mode.
 *
 * C'est la boutique d'origine, avant la gamme de cinq références (jalon C) :
 * la variante que MAILLE & CO joue aux premiers niveaux de difficulté, où
 * une seule référence suffit à apprendre la marge et le stock. La gamme
 * prend le relais au niveau où le mix devient une décision.
 *
...
const rawBoutique = {
  ...
  events: [
    ...
    },
    {
      ...
      probability: 0,
      duration: 2,
      modifiers: [{ target: "demand", op: "mul", value: 0.86 }],
    },
    {
      ...
      probability: 0,
      duration: 1,
      modifiers: [{ target: "demand:chalands", op: "mul", value: 0.8 }],
    },
    {
...
export const boutiqueMonoScenario: EngineScenarioConfig = parseScenarioConfig(rawBoutique);
 ...
 */
export function boutiqueMonoCompany(
  id: string,
  name: string,
...
export const boutiqueMonoBots: { id: string; name: string; profile: BotProfile }[] = [
