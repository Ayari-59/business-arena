...
/**
 * Situations pédagogiques de MAILLE & CO en un seul article (commerce de
 * détail, variante mono-produit des premiers niveaux). Les codes sont
 * préfixés « bmono_ » : ceux de la gamme portent « boutique_ », et un code de
 * situation est unique dans toute la plateforme.
 *
 ...
 */
export const BOUTIQUE_MONO_SITUATIONS: SituationDef[] = [
  {
    code: "bmono_t1_reprise",
  ...
  {
    code: "bmono_detect_below_breakeven",
  ...
  {
    code: "bmono_detect_profitable_illiquid",
    category: "alerte_comptable",
