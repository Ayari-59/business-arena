 ...
 *
 * Cinq séances de quatre heures sur NOVA, à un niveau de jeu qui ouvre le
...
export const ATELIER_DCG: AtelierDefinition = {
  ...
  pitch:
    "Cinq séances de quatre heures. Chaque équipe dirige la même entreprise industrielle, construit ses budgets, analyse ses écarts, décide d'investir et de se financer, et rend un rapport financier qu'elle soutient devant un jury.",
  resume:
  ...
  seances: [
    ...
    },
    {
      ...
      preparation:
        "Remettez la grille de soutenance à la séance précédente. Prévoyez un jury où siège au moins un collègue ou un professionnel, et un ordre de passage tiré au sort. Quinze minutes de soutenance et dix minutes de questions par équipe.",
      deroule: [
        {
          minutes: 15,
        ...
        },
        {
          ...
          detail:
            "Les équipes reprennent les quatre trimestres et rédigent leur rapport : diagnostic d'ouverture, décisions, écarts, situation de sortie, préconisations. Quatre pages au maximum.",
        },
        {
          minutes: 25,
        ...
        },
        {
          ...
          titre: "Soutenances",
          detail:
            "Passage des équipes devant le jury, quinze minutes de présentation et dix minutes de questions. Les questions portent sur les méthodes autant que sur les résultats.",
        },
        {
          minutes: 30,
      ...
      livrable:
        "Le rapport de gestion, quatre pages : diagnostic d'ouverture, décisions et leurs justifications, analyse des écarts, situation financière de sortie, deux préconisations chiffrées, plus la soutenance de quinze minutes.",
      tracePasseport:
  ...
  faq: [
    ...
    {
      question: "La séance d'analyse des écarts peut-elle se tenir en quatre heures ?",
      reponse:
