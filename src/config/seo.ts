...
import { ALL_SITUATIONS, SCENARIOS } from "./scenarios/registry";
...
export const DESCRIPTION_ACCUEIL = `Jeu d'entreprise pédagogique à essayer gratuitement, sans compte élève : ${SCENARIOS.length} secteurs, ${ALL_SITUATIONS.length} situations, ${DECISION_MODELS.length} modèles d'analyse. Pilotez prix, production, trésorerie et affrontez la concurrence.`;
