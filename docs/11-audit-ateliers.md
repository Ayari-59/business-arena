...
Lot 2 livré le 16 septembre 2026 (commit « feat(ateliers): lot 2 de l'audit ») : échelle d'exigence unique, épreuves nommées, treize fiches notions nouvelles et notions reliées aux fiches sur les pages d'atelier, oraux chiffrés, traces à un acte, livrables nommés, compléments STMG, CG1, DCG, DCG-RSE, GPME, MHR, avec trois gardes nouvelles (échelle, traces, notions couvertes). Restent au lot 3 : l'assurance de MHR sans phase, la situation « 18 % de commission » de l'hôtel que le moteur ne modélise pas, et les points lourds de la section 5.

Lot 3 livré le 16 septembre 2026 (commit « feat(ateliers): lot 3 de l'audit ») : la gouvernance RSE ne pénalise plus un plan de trésorerie que l'arène ne permet plus de déposer (`src/scoring/rse.ts`, le dépôt reste un bonus) ; DCG joue l'investissement en S3 (tour 3) et les écarts en S4 (tour 4), le trimestre où la capacité achetée entre en service ; GEA écrit la gamme (S1 : coût de revient et marge par enceinte, seuil au mix, question de la recherche de la Studio ; S3 : facteur rare, classement par marge rapportée à la capacité, lignes typées en service au trimestre suivant) ; MHR réécrit sa S3 autour de la bascule de clientèles de l'été (loisirs élastiques payés comptant, affaires et groupes de retour au trimestre suivant à trente et quarante-cinq jours) et donne une phase à l'assurance en S4 ; Avancé suit enfin le scénario transport (S2 retour à vide et coût marginal, S3 gazole répercuté par clientèle et capacité préparée pour le pic, S4 grand compte à soixante jours en plein pic, S5 renouvellement de la flotte par la valeur actuelle nette et placement). Deux ateliers nouveaux : « Composer la carte et tenir le service » (BTS MHR options B et C, deuxième année, LA TABLE D'AUGUSTIN en gamme, niveau Arbitrage, cinq séances, quatre tours) et « Garder ses adhérents plutôt que les remplacer » (BTS NDRC deuxième année, VOLT FITNESS, niveau Pilotage, six séances, cinq tours). Le référentiel NDRC couvre l'atelier fitness par la même liste ; le bistrot rejoint `REFERENTIELS_NON_VERIFIES` avec l'hôtel. Restent hors lot : la situation « 18 % de commission » de l'hôtel, que le moteur ne modélise pas, et la relecture des arrêtés MHR et GEA.
